...
class Getnet_Gateway extends WC_Payment_Gateway
{
   ...
   public function __construct()
   {
      ...
      $this->method_description = __('Integrates Getnet payment method into Woocommerce Subscriptions checkout', 'getnet');
      ...
      $this->_api             = new Hero99\Getnet\API( $this->seller_id, $this->client_id, $this->client_secret, $this->isSandbox());
   ...
   public function init_form_fields()
   {
      $this->form_fields = [
         ...
         'title' => [
            ...
            'default'     => __('Getnet Hero99', 'getnet'),
            'desc_tip'    => true,
         ],
         'description' => [
   ...
   public function payment_fields()
   {
      ...
      wc_get_template(
         ...
         [
            'installments' => Hero99\Getnet\Utils::getInstallments( $orderAmount, (int) $this->min_installment, (int) $this->installments)
         ],
         'woocommerce/getnet/',
         Hero99\Getnet\Utils::getTemplatesPath()
      );
   }
   ...
   public function process_payment($order_ID)
   {
      ...
      if ($payment->success) :
         ...
         //points ounces create subscription
         $total = $order->get_total();
         $user_id = $order->get_user_id();

         $valorPoints = number_format($total);
         $points = get_user_meta($user_id ,'points_ounces', true);
         $pointsTotal = $valorPoints + $points;
         update_user_meta($user_id ,'points_ounces', $pointsTotal); 
   ...
   public function enqueueCheckoutAssets()
   {
      ...
      $url = Hero99\Getnet\Utils::getAssetsUrl();
