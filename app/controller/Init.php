...
class Init
{
   public function init()
   {
      ...
      require_once WC_HERO99_APP . '/controller/Utils.php';
      ...
      elseif(!class_exists('Extra_Checkout_Fields_For_Brazil')):
         ...
         add_filter('plugin_action_links_' . plugin_basename(WC_HERO99_FILE), [$this, 'enqueueActionsLinks']);
   ...
   {
      $path = dirname( plugin_basename( WC_HERO99_FILE ) ) . '/app/languages';
   ...
   {
      require_once WC_HERO99_APP . '/controller/API.php';
      require_once WC_HERO99_APP . '/controller/Getnet_Gateway.php';
